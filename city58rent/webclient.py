...
class WebBrowser(object):
    ...
    def _request(self, url, data=None, headers=None, cookies=None, referer=None, ajax = False, method = 'GET', timeout = None):
        if headers:
        ...
        try:
            ...
            rep_headers = response.info()

            response.close()

        return (content, rep_headers)
